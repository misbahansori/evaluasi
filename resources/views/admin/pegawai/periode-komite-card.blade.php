<div class="card-header bg-white d-flex justify-content-between">
    <h4>Penilaian Komite</h5>
    @can('tambah periode')
        <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#periodeKomiteModal">
...
<div class="card-body">
    <table class="table">
        @forelse ($pegawai->periodeKomite as $periode)
            <tr>
