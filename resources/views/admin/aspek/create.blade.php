        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-white">
                    <h4>Tambah Data Aspek</h4>
                </div>

                <div class="card-body">
                    <form action="{{ route('aspek.store') }}" class="form" method="POST">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="nama" type="text" class="form-control{{ $errors->has('nama') ? ' is-invalid' : '' }}" name="nama" rows="3" required autofocus>{{ old('nama') }}</textarea>
